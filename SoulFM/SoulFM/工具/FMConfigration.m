...
- (id)init
{
    if (self = [super init]) {
        ...
        [self.dicConfig setValue:@"FMReaderInfoEngine" forKey:kFMReaderInfoConfigKey];
        [self.dicConfig setValue:@"FMReaderContentListEngine" forKey:kFMReaderListConfigKey];
    }
    return self;
}
